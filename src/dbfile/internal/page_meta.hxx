...
class HeapMeta : public PageMixin {
  public:
     ...
     */
    auto get_raw_bytes_at(std::istream& t_in, uint16_t t_off) const
        -> std::vector<std::byte>;
    ...
    class HeapPointer {
      public:
         ...
         */
        [[nodiscard]] constexpr auto get_local_offset() const noexcept
            -> uint32_t {
            return m_off;
        }
         ...
         */
        [[nodiscard]] constexpr auto get_total_offset() const noexcept
            -> uint64_t {
